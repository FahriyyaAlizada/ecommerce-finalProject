function addProduct(){
    ...
    productForm.addEventListener('submit', (e) => {
        ...
        const product = {
            ...
            description: document.getElementById('message-box').value,
        ...
        if (productId) {
            ...
            fetch('http://localhost:8040/products/create', {
                method: 'POST',
                headers: {
...
function editProduct(){
    ...
    const productId = urlParams.get('id');
      ...
      if (productId) {
        ...
        fetch(`http://localhost:8040/products/getById/${productId}`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
            }
            ...
            .then(async response => {
                if (response.ok) {
                    ...
                    document.getElementById('message-box').value = object.description;
...
function updateProduct(product,productId) {
    ...
    productForm.addEventListener('submit', (e) => {
        ...
        fetch('http://localhost:8040/products/update', {
            method: 'PUT',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
